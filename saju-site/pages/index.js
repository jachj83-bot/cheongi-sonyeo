...
export default function Home() {
  ...
  const [form, setForm] = useState({ name: '', year: '', month: '', day: '', hour: '', gender: '' });
      ...
      <div style={{minHeight:'100vh',background:'#080b14',color:'#e8e0d0',fontFamily:'sans-serif'}}>
        ...
        {step === 'input' && (
          <div style={{maxWidth:'480px',margin:'0 auto',padding:'60px 24px'}}>
            ...
            <div style={{marginBottom:'20px'}}>
              <label style={{display:'block',fontSize:'13px',color:'rgba(232,224,208,0.6)',marginBottom:'8px'}}>태어난 시간 (12지신)</label>
